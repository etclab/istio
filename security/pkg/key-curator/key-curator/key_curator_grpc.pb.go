...
type KeyCuratorClient interface {
	...
	FetchAllUpdates(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*AllUpdatesResponse, error)
	FetchPublicParams(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*PublicParamsResponse, error)
...
func (c *keyCuratorClient) FetchAllUpdates(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*AllUpdatesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *keyCuratorClient) FetchPublicParams(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*PublicParamsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type KeyCuratorServer interface {
	...
	FetchAllUpdates(context.Context, *empty.Empty) (*AllUpdatesResponse, error)
	FetchPublicParams(context.Context, *empty.Empty) (*PublicParamsResponse, error)
...
func (UnimplementedKeyCuratorServer) FetchAllUpdates(context.Context, *empty.Empty) (*AllUpdatesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FetchAllUpdates not implemented")
}
func (UnimplementedKeyCuratorServer) FetchPublicParams(context.Context, *empty.Empty) (*PublicParamsResponse, error) {
...
func _KeyCurator_FetchAllUpdates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyCuratorServer).FetchAllUpdates(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _KeyCurator_FetchPublicParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyCuratorServer).FetchPublicParams(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
